...
public class HNDIT1210adm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_n_d_i_t1210adm);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("HNDIT").child("1st Year 2nd Sem").child("GM");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myViewFiles.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(HNDIT1210adm.this);
