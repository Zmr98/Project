...
public class HNDIT2417adm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_n_d_i_t2417adm);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("HNDIT").child("2nd Year 2nd Sem").child("MAD");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myViewFiles.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(HNDIT2417adm.this);
