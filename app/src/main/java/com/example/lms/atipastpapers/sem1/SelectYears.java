...
public class SelectYears extends AppCompatActivity {
    ...
    Button itBtn1, itBtn2, itBtn3, itBtn4, itBtn5, itBtn6;
    ImageView itbackBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itBtn6 = (Button) findViewById(R.id.itexped6);
        ...
        itBtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SelectYears.this, Year2013.class));
            }
        });
        ...
        itBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SelectYears.this, Year2014.class));
            }
        });
        ...
        itBtn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        itBtn6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SelectYears.this, "Uploading Soon...", Toast.LENGTH_SHORT).show();
            }
        });
