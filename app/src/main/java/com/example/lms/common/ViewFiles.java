...
public class ViewFiles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //final ArrayList<UploadFiles> items = new ArrayList<>();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    //items.add(ds.getValue(UploadFiles.class));
                ...
                myViewFiles.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view,final int position, long id) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(ViewFiles.this);
