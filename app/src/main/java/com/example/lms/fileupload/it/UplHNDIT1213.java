...
public class UplHNDIT1213 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upl_h_n_d_i_t1213);

        //Assigning Variables id
        getSupportActionBar().setTitle("Data Communications and Networks");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("HNDIT/1st Year 2nd Sem/DCN");
    ...
    private void uploadTheFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("HNDIT/1st Year 2nd Sem/DCN/"+editFileName.getText().toString()+".pdf");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(UplHNDIT1213.this, "File Uploaded", Toast.LENGTH_SHORT).show();
