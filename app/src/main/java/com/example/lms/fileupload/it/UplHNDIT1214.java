...
public class UplHNDIT1214 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upl_h_n_d_i_t1214);

        getSupportActionBar().setTitle("Statistics for IT");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("HNDIT/1st Year 2nd Sem/STATISTICS");
    ...
    private void uploadTheFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("HNDIT/1st Year 2nd Sem/STATISTICS/"+editFileName.getText().toString()+".pdf");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(UplHNDIT1214.this, "File Uploaded", Toast.LENGTH_SHORT).show();
