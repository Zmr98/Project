...
public class UplHNDIT1215 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upl_h_n_d_i_t1215);

        getSupportActionBar().setTitle("English for Technology II");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("HNDIT/1st Year 2nd Sem/ENGLISH");
    ...
    private void uploadTheFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("HNDIT/1st Year 2nd Sem/ENGLISH/"+editFileName.getText().toString()+".pdf");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(UplHNDIT1215.this, "File Uploaded", Toast.LENGTH_SHORT).show();
