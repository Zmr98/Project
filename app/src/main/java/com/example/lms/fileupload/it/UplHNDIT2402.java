...
public class UplHNDIT2402 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upl_h_n_d_i_t2402);

        getSupportActionBar().setTitle("Open Source Systems");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("HNDIT/2nd Year 2nd Sem/OSS");
    ...
    private void uploadTheFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("HNDIT/2nd Year 2nd Sem/OSS/"+editFileName.getText().toString()+".pdf");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(UplHNDIT2402.this, "File Uploaded", Toast.LENGTH_SHORT).show();
