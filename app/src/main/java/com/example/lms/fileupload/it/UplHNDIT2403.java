...
public class UplHNDIT2403 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upl_h_n_d_i_t2403);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("HNDIT/2nd Year 2nd Sem/Professional issues in IT");
    ...
    private void uploadTheFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("HNDIT/2nd` Year 2nd Sem/Professional issues in IT/"+editFileName.getText().toString()+".pdf");
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(UplHNDIT2403.this, "File Uploaded", Toast.LENGTH_SHORT).show();
